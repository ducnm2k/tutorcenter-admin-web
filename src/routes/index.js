    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        },
        {
          path: 'account',
          children: [
            { path: '/', element: <Navigate to="/dashboard/account/cards" replace /> },
            { path: 'cards', element: <AccountCard /> },
        ...
        {
          path: 'systemVariable/:name/edit',
          element: <SystemVariableEdit />
        },
        {
          path: 'statistic',
          element: <Statistic />
        ...
        {
          path: 'transactionHistory/:name/detail',
...
// Dashboard System
// Dashboard System : Account
const AccountCard = Loadable(lazy(() => import('../pages/dashboard/AccountCards')));
...
// Dashboard System : Variable
const SystemVariable = Loadable(lazy(() => import('../pages/dashboard/SystemVariable')));
const SystemVariableEdit = Loadable(lazy(() => import('../pages/dashboard/SystemVariableEdit')));

// Dashboard Revenue
// Dashboard Revenue : Statistic
const Statistic = Loadable(lazy(() => import('../pages/dashboard/RevenueStatistic')));
// Dashboard Revenue : History
const TransactionHistory = Loadable(lazy(() => import('../pages/dashboard/TransactionHistory')));
const TransactionHistoryDetail = Loadable(lazy(() => import('../pages/dashboard/TransactionHistoryDetail')));
