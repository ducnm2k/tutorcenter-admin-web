...
const TABLE_HEAD = [
  { id: 'name', label: 'Key', alignRight: false },
  { id: 'price', label: 'Value', alignRight: true },
  { id: 'createdAt', label: 'Last Modified', alignRight: false }
];
                  ...
                  {filteredProducts.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    ...
                    return (
                      <TableRow
                        ...
                        tabIndex={-1}
                        component={RouterLink}
                        to={`${PATH_DASHBOARD.systemVariable}/${name}/edit`}
                        // role="checkbox"
